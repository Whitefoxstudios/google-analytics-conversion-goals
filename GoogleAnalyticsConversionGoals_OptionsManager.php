...
class GoogleAnalyticsConversionGoals_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'google-analytics-conversion-goals'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'google-analytics-conversion-goals'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'google-analytics-conversion-goals'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'google-analytics-conversion-goals'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'google-analytics-conversion-goals');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'google-analytics-conversion-goals'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'google-analytics-conversion-goals');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'google-analytics-conversion-goals'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'google-analytics-conversion-goals') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'google-analytics-conversion-goals');
            case 'false':
                return __('false', 'google-analytics-conversion-goals');

            case 'Administrator':
                return __('Administrator', 'google-analytics-conversion-goals');
            case 'Editor':
                return __('Editor', 'google-analytics-conversion-goals');
            case 'Author':
                return __('Author', 'google-analytics-conversion-goals');
            case 'Contributor':
                return __('Contributor', 'google-analytics-conversion-goals');
            case 'Subscriber':
                return __('Subscriber', 'google-analytics-conversion-goals');
            case 'Anyone':
                return __('Anyone', 'google-analytics-conversion-goals');
        }
        return $optionValue;
    }
