...
include_once('GoogleAnalyticsConversionGoals_OptionsManager.php');

class GoogleAnalyticsConversionGoals_InstallIndicator extends GoogleAnalyticsConversionGoals_OptionsManager {
