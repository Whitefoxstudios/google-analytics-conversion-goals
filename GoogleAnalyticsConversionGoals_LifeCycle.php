...
include_once('GoogleAnalyticsConversionGoals_InstallIndicator.php');

class GoogleAnalyticsConversionGoals_LifeCycle extends GoogleAnalyticsConversionGoals_InstallIndicator {
